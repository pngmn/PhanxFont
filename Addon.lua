...
function Addon:SetFonts(event, addon)
	...
	self:SetFont(Fancy22Font,                               NORMAL, 22, "", 1, .82, nil, nil, nil, nil, nil, nil)
	...
	self:SetFont(FriendsFont_11,                            NORMAL, 11, "", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(FriendsFont_Large,                         NORMAL, 14, "", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(FriendsFont_Normal,                        NORMAL, 12, "", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(FriendsFont_Small,                         NORMAL, 10, "", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(FriendsFont_UserText,                      NORMAL, 11, "", nil, nil, nil, nil, nil, nil, 1, -1)
	...
	self:SetFont(Game11Font_Shadow,                         NORMAL, 11, "", nil, nil, nil, nil, nil, nil, nil, nil)
	...
	self:SetFont(Game13FontShadow,                          NORMAL, 13, "", nil, nil, nil, nil, nil, nil, 1, -1)
	...
	self:SetFont(Game17Font_Shadow,                         NORMAL, 17, "", nil, nil, nil, nil, nil, nil, nil, nil)
	...
	self:SetFont(Game32Font_Shadow2,                        NORMAL, 32, "", nil, nil, nil, nil, nil, nil, nil, nil)
	self:SetFont(Game32Font,                                NORMAL, 32, "", nil, nil, nil, nil, nil, nil, nil, nil)
	self:SetFont(Game36Font_Shadow2,                        NORMAL, 36, "", nil, nil, nil, nil, nil, nil, nil, nil)
	self:SetFont(Game36Font,                                NORMAL, 36, "", nil, nil, nil, nil, nil, nil, nil, nil)
	self:SetFont(Game40Font_Shadow2,                        NORMAL, 40, "", nil, nil, nil, nil, nil, nil, nil, nil)
	...
	self:SetFont(Game46Font_Shadow2,                        NORMAL, 46, "", nil, nil, nil, nil, nil, nil, nil, nil)
	...
	self:SetFont(Game48FontShadow,                          NORMAL, 48, "", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(Game52Font_Shadow2,                        NORMAL, 52, "", nil, nil, nil, nil, nil, nil, nil, nil)
	self:SetFont(Game58Font_Shadow2,                        NORMAL, 58, "", nil, nil, nil, nil, nil, nil, nil, nil)
	self:SetFont(Game60Font,                                NORMAL, 60, "", nil, nil, nil, nil, nil, nil, nil, nil)
	self:SetFont(Game69Font_Shadow2,                        NORMAL, 69, "", nil, nil, nil, nil, nil, nil, nil, nil)
	self:SetFont(Game72Font_Shadow,                         NORMAL, 72, "", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(Game72Font,                                NORMAL, 72, "", nil, nil, nil, nil, nil, nil, nil, nil)
	self:SetFont(GameFont_Gigantic,                         NORMAL, 32, "", 1.0, 0.82, nil, 0.0, 0.0, 0.0, 1, -1)
	...
	self:SetFont(NumberFont_GameNormal,                     NORMAL, 10, "", nil, nil, nil, nil, nil, nil, 1, -1)
	...
	self:SetFont(NumberFont_Shadow_Large,                   NORMAL, 20, "", nil, nil, nil, nil, nil, nil, nil, nil)
	self:SetFont(NumberFont_Shadow_Med,                     NORMAL, 14, "", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(NumberFont_Shadow_Small,                   NORMAL, 12, "", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(NumberFont_Shadow_Tiny,                    NORMAL, 10, "", nil, nil, nil, nil, nil, nil, 1, -1)
	...
	self:SetFont(QuestFont_Enormous,                        NORMAL, 30, "", 1, .82, nil, nil, nil, nil, nil, nil)
	...
	self:SetFont(QuestFont_Super_Huge_Outline,              NORMAL, 24, "OUTLINE", 1, .82, nil, nil, nil, nil, nil, nil)
	self:SetFont(QuestFont_Super_Huge,                      NORMAL, 24, "", 1, .82, nil, nil, nil, nil, nil, nil)
	...
	self:SetFont(SplashHeaderFont,                          NORMAL, 24, "", 1, .82, nil, nil, nil, nil, 1, -2)
	...
	self:SetFont(SystemFont_LargeNamePlate,                 NORMAL, 12, "", nil, nil, nil, nil, nil, nil, nil, nil)
	self:SetFont(SystemFont_LargeNamePlateFixed,            NORMAL, 20, "", nil, nil, nil, nil, nil, nil, 1, -1)
	...
	self:SetFont(SystemFont_NamePlate,                      NORMAL, 9, "", nil, nil, nil, nil, nil, nil, nil, nil)
	self:SetFont(SystemFont_NamePlateCastBar,               NORMAL, 10, "OUTLINE", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_NamePlateFixed,                 NORMAL, 14, "", nil, nil, nil, nil, nil, nil, 1, -1)
	...
	self:SetFont(SystemFont_Shadow_Huge1_Outline,           NORMAL, 20, "OUTLINE", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Huge1,                   NORMAL, 20, "", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Huge2_Outline,           NORMAL, 24, "OUTLINE", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Huge2,                   NORMAL, 24, "", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Huge3,                   NORMAL, 25, "", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Huge4_Outline,           NORMAL, 27, "OUTLINE", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Huge4,                   NORMAL, 27, "", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Large_Outline,           NORMAL, 16, "OUTLINE", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Large,                   NORMAL, 16, "", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Large2_Outline,          NORMAL, 18, "OUTLINE", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Large2,                  NORMAL, 18, "", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Med1_Outline,            NORMAL, 12, "OUTLINE", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Med1,                    NORMAL, 12, "", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Med2_Outline,            NORMAL, 14, "OUTLINE", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Med2,                    NORMAL, 14, "", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Med3_Outline,            NORMAL, 14, "OUTLINE", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Med3,                    NORMAL, 14, "", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Outline_Huge3,           NORMAL, 25, "OUTLINE", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Small_Outline,           NORMAL, 10, "OUTLINE", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Small,                   NORMAL, 10, "", nil, nil, nil, nil, nil, nil, nil, nil)
	self:SetFont(SystemFont_Shadow_Small2_Outline,          NORMAL, 11, "OUTLINE", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_Shadow_Small2,                  NORMAL, 11, "", nil, nil, nil, nil, nil, nil, 1, -1)
	...
	self:SetFont(SystemFont_World_ThickOutline,             NORMAL, 64, "THICKOUTLINE", nil, nil, nil, nil, nil, nil, 1, -1)
	self:SetFont(SystemFont_World,                          NORMAL, 64, "", nil, nil, nil, nil, nil, nil, 1, -1)
	...
	self:SetFont(SystemFont22_Shadow_Outline,               NORMAL, 22, "OUTLINE", nil, nil, nil, nil, nil, nil, 2, -2)
